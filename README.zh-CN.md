...
**核心指标**：
- `chaingraph_queries_total` - 总查询数
- `chaingraph_buffer_pool_hit_rate` - 缓冲池命中率
- `chaingraph_slow_queries_total` - 慢查询计数
- `chaingraph_qps` - 每秒查询数
